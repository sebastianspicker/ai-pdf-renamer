...
from .renamer_discovery import _collect_pdf_files_with_config
...
def _run_watch_iteration(
    ...
    *,
    ...
    rules = deps.load_processing_rules_fn(config.rules_file, raise_on_error=bool(config.rules_file))
