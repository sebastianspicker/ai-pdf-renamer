...
logger = logging.getLogger("ai_pdf_renamer.heuristics")
...
def _score_text(
    ...
    **overrides: object,
    ...
    """
    opts = merge_options(options or ScoringOptions(), overrides)
...
class HeuristicScorer:
    ...
    def best_category_with_confidence(
        ...
        **overrides: object,
        ...
        """
        opts = merge_options(options or ConfidenceOptions(), overrides)
    ...
    def top_n_categories(
        ...
        **overrides: object,
        ...
        opts = merge_options(options or TopNOptions(), overrides)
