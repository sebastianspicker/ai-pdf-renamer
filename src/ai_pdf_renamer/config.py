...
class RenamerConfig:
    # Naming convention for boolean fields:
    # - use_*: Enable/disable a feature (on/off toggle)
    # - prefer_*: When multiple sources are available, prefer this one
    # - skip_*: Skip a step under certain conditions
    language: str = "de"
    ...
    # Require HTTPS for non-localhost LLM endpoints (env: AI_PDF_RENAMER_REQUIRE_HTTPS)
