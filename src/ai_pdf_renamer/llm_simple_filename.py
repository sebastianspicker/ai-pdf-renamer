...
from .llm_parsing import _replace_prompt_placeholders, truncate_for_llm
from .llm_prompts import _escape_doc_content
...
def get_document_filename_simple(
    ...
    **overrides: object,
    ...
    opts = merge_options(options or SimpleFilenameOptions(), overrides)
