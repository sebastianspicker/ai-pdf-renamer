"""Canonical reviewed-plan creation and exact reviewed-target application."""
...
from .proposals import produce_proposals
...
def create_preview_plan(
    ...
    *,
    ...
    return PreviewPlan(
        ...
        config=config,
        items=_preview_items(proposals, fingerprints),
