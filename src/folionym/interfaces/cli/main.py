...
settings so CLI and interactive runs produce the same RenamerConfig shape.
"""
...
from ...application.batch import rename_pdfs_in_directory, run_watch_loop
...
from .config import ConfigLoadError, _load_config_file, _load_override_category_map, load_config_file
...
def _probe_llm_endpoint(
    ...
    if use_chat_api:
        from ...llm.http import _chat_url_from_completions_url
