...
from .frontend_service import ApplyReport, PreviewPlan, apply_reviewed_plan, create_preview_plan
...
class RunRegistry:
    ...
    def start_preview(self, source: Path, settings: dict[str, object]) -> str:
        ...
        config = build_config_from_snapshot(settings, run.stop_event, dry_run=True)
