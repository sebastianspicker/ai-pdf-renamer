"""Exercise strict and lenient parsing of untrusted LLM responses."""
...
from folionym.llm_parsing import (
    TRUNCATION_SUFFIX,
...
class TestParseJsonFieldSalvageChain:
    ...
    def test_parse_json_field_all_salvage_fails(self, caplog: object) -> None:
        ...
        with patch("folionym.llm_parsing.logger") as mock_logger:
            result = parse_json_field(response, key="summary")
    ...
    def test_parse_json_field_warning_redacts_malformed_response(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        with caplog.at_level(logging.WARNING, logger="folionym.llm_parsing"):
