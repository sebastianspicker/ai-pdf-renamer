...
from folionym.tui_assets import (
    _DRYRUN_LOG_RE,
    _RENAME_LOG_RE,
    ERROR_COLOR,
    FOLIONYM_THEME,
...
def test_approved_ledger_theme_is_light_and_uses_semantic_tokens() -> None:
    """The production TUI uses the approved design-system palette."""
    assert FOLIONYM_THEME.dark is False
    assert PREVIEW_COLOR == "#2468E5"
    assert SUCCESS_COLOR == "#087F70"
    assert WARNING_COLOR == "#A45D00"
    assert ERROR_COLOR == "#B42318"
